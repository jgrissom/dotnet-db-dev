...
- [ ] 💡 **One sentence on the last one, then move on** — *"That last one does have a one-line spelling, and it reads worse. A one-liner is not the goal, especially when it makes the code harder to read."*
