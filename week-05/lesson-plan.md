...
| 1:42 | 10 min | **☕ Break** |
| 1:52 | 25 min | 💥 **Two names, one object** *(slides 9–10, demo §6)*. The muster, on a copy, marks everybody in — and the real board reads `0 people outside.` with all three still on the ice. Then what a copy actually copies, and the muster made read-only. |
