...
| 3:32 | 13 min | **Wrap-up** *(slide 12, demo §9)*. `static` · instance · a reference · `null`. Two URLs in Canvas. Week 6 tease: **one list, one loop, four different kinds of thing.** |
