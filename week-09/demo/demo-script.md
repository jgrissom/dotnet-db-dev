...
- [ ] 💡 **One sentence on `Everything`, then move on** — *"`Everything` in your own project does have a one-line spelling, and it reads worse. A one-liner is not the goal, especially when it makes the code harder to read."*
