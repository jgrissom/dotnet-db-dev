...
- ⚠️ **The instructor rehearsal repo reset to empty** (`~/Repos/dotnet-db-dev-course/instructor/dotnet-db-coursework`), any rehearsal `Haldane` deleted. The finished state lives in the private repo as `week-01/demo-starter/Haldane` — **rehearse against it, don't open it in class**
