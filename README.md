...
| 2 | The mistakes the compiler *can't* catch: parsing input that lies, `null`, and reading a warning you'd have ignored. Git hygiene: `.gitignore`, commit messages, README | `git status` right after your first build: forty files you never wrote | [`week-⁠02/`](week-02/) | ✅&nbsp;Ready |
