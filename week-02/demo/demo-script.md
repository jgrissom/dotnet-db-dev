...
- [ ] Setup on screen, said once: **pull `dotnet-db-starters` → copy the one `week-02` folder into your repo → `dotnet test week-02/Lab.Checks`** → **1 / 5**. *"Nothing to open — your window is already the right window. One folder in, one command, and the week is live"*
