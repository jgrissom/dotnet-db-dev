...
- **§6 is the only segment where the room talks more than you do.** Take two or three topics out loud and pressure-test each one against *"has many."* A topic that can't finish the sentence is cheaper to kill tonight than in November.
