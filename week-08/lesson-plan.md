...
- 💡 **§6 ends with a ten-second plant for week 9** — the clock is real, the DAY is still typed into the source and hand-edited every week. It is collected in week 9's §5, where the console starts reading the day off the met book. **Say it and move on; nothing in week 8 fixes it.**
